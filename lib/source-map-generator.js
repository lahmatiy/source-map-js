...
class SourceMapGenerator {
  ...
  setSourceContent(sourceFile, sourceContent) {
    ...
    if (sourceContent != null) {
      ...
      this._sourcesContents[util.toSetString(sourceFile)] = sourceContent;
    } else if (this._sourcesContents) {
      // Remove the source file from the _sourcesContents map.
      // If the _sourcesContents map is empty, set the property to null.
      delete this._sourcesContents[util.toSetString(sourceFile)];
  ...
  _generateSourcesContent(sources, sourceRoot) {
    return sources.map((source) => {
      ...
      return hasOwnProperty.call(this._sourcesContents, key)
